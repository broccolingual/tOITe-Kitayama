...
def updateDictWindow_Tutorial(dictWindow):
    layoutTutorial1 = make_fullimage_layout(
        "images/tutorial1.png", "TUTORIAL_1")
    layoutTutorial2 = make_fullimage_layout(
        "images/tutorial2.png", "TUTORIAL_2")
    layoutTutorial3 = make_fullimage_layout(
        "images/tutorial3.png", "TUTORIAL_3")
